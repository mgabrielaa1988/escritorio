...
void getStringAlphaNumeric(char*dato, char*msj, int len)
{
    ...
    do
    {
        ...
        for(i=0; i<lengthDato; i++)
        {
            if((*(dato+i) < 'a' || *(dato+i) > 'z') && (*(dato+i) < 'A' || *(dato+i) > 'Z') && (*(dato+i) < '0' || *(dato+i) > '9') && (*(dato+i) != '.') && (*(dato+i) != ' ') && (*(dato+i) != ',') && (*(dato+i) != 39) && (*(dato+i) != '-') && (*(dato+i) != ':'))
            {
                printf("Invalido.\n");
                datoValido=1;
                break;
...
void getStringLinks(char*dato, char*msj, int len)
{
    int i, lengthDato, datoValido;
    ...
    do
    {
        ...
        for(i=0; i<lengthDato; i++)
        {
            if((*(dato+i) < 'a' || *(dato+i) > 'z') && (*(dato+i) < 'A' || *(dato+i) > 'Z') && (*(dato+i) < '0' || *(dato+i) > '9') && (*(dato+i) != '.') && (*(dato+i) != ' ') && (*(dato+i) != '/') && (*(dato+i) != ':') && (*(dato+i) != '&') && (*(dato+i) != '=') && (*(dato+i) != '-') && (*(dato+i) != '@') && (*(dato+i) != '_') && (*(dato+i) != ','))
            {
                printf("Invalido.\n");
                datoValido=1;
                break;
